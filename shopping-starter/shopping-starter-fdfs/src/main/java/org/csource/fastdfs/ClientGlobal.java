...
public class ClientGlobal {
   ...
   */
  public static void init(String conf_filename) throws IOException, FdfsException {
   ...
   *                      server之间用逗号','分隔
   */
  public static void initByProperties(String propsFilePath) throws IOException, FdfsException {
  ...
  public static void initByProperties(Properties props) throws IOException, FdfsException {
    ...
    if (trackerServersConf == null || trackerServersConf.trim().length() == 0) {
      throw new FdfsException(String.format("configure item %s is required", PROP_KEY_TRACKER_SERVERS));
    }
   ...
   *                       server之间用逗号','分隔
   */
  public static void initByTrackers(String trackerServers) throws IOException, FdfsException {
  ...
  public static void initByTrackers(InetSocketAddress[] trackerAddresses) throws IOException, FdfsException {
