...
public class TrackerClient {
     ...
     */
    public StorageServer getStoreStorage(TrackerServer trackerServer) throws IOException, FdfsException {
     ...
     */
    public StorageServer getStoreStorage(TrackerServer trackerServer, String groupName) throws IOException, FdfsException {
        byte[] header;
        String ip_addr;
        int port;
        byte cmd;
     ...
     */
    public StorageServer[] getStoreStorages(TrackerServer trackerServer, String groupName) throws IOException, FdfsException {
        byte[] header;
        String ip_addr;
        int port;
        byte cmd;
    ...
    public StorageServer getFetchStorage(TrackerServer trackerServer,
                                         String groupName, String filename) throws IOException, FdfsException {
    ...
    protected ServerInfo[] getStorages(TrackerServer trackerServer,
                                       byte cmd, String groupName, String filename) throws IOException, FdfsException {
        byte[] header;
        byte[] bFileName;
        byte[] bGroupName;
        byte[] bs;
     ...
     * @return storage server Socket object, return null if fail
     */
    public StorageServer getFetchStorage1(TrackerServer trackerServer, String file_id) throws IOException, FdfsException {
     ...
     * @return storage servers, return null if fail
     */
    public ServerInfo[] getFetchStorages1(TrackerServer trackerServer, String file_id) throws IOException, FdfsException {
        String[] parts = new String[2];
        this.errno = StorageClient1.split_file_id(file_id, parts);
        if (this.errno != 0) {
            return null;
     ...
     */
    public StructGroupStat[] listGroups(TrackerServer trackerServer) throws IOException, FdfsException {
        byte[] header;
        String ip_addr;
        int port;
        byte cmd;
     ...
     */
    public StructStorageStat[] listStorages(TrackerServer trackerServer, String groupName) throws IOException, FdfsException {
    ...
    public StructStorageStat[] listStorages(TrackerServer trackerServer,
                                            String groupName, String storageIpAddr) throws IOException, FdfsException {
        byte[] header;
        byte[] bGroupName;
        byte[] bs;
        int len;
     ...
     * @return true for success, false for fail
     */
    public boolean deleteStorage(String groupName, String storageIpAddr) throws IOException, FdfsException {
